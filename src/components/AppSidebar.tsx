...
import { LayoutDashboard, ShoppingCart, ShoppingBag, Receipt, Users, UserCog, Package, LogOut, Home, LayoutGrid, UserPlus, Star } from "lucide-react";
import {
...
import { ShoppingBag, Boxes, Hammer, Wrench, Truck, BarChart2, PackageCheck, Tag } from "lucide-react"; // ya lo tienes importado
...
const items = [
  ...
  { title: "Reseñas", url: "/resenas", icon: Star, roles: ["admin", "vendedor"] as AppRole[] },
  ...
  { title: "Cupones", url: "/cupones", icon: Tag, roles: ["admin"] as AppRole[] },
